...
// configuration step. It creates a namespace called `chess`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", chess::cmake::project_name, chess::cmake::project_version) };
